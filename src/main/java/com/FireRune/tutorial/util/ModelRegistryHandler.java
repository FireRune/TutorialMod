...
public class ModelRegistryHandler {
	...
	public static void registerModels(ModelRegistryEvent event) {
		...
		registerModel(TutorialItems.INGOT_COPPER);
		...
		registerModel(Item.getItemFromBlock(TutorialBlocks.BLOCK_COPPER));
		registerModel(Item.getItemFromBlock(TutorialBlocks.ORE_COPPER));
	}
