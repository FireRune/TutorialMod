package com.FireRune.tutorial.world.gen;
...
public class TutorialWorldGen implements IWorldGenerator {
	...
	public TutorialWorldGen() {
		genTutorial_overworld=new WorldGenMinable(TutorialBlocks.ORE_COPPER.getDefaultState(), 15, BlockMatcher.forBlock(Blocks.STONE));
	}
